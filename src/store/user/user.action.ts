...
export type ChekUserSession = Action<USER_ACTION_TYPES.CHECK_USER_SESSION>;
...
export const checkUserSession = withMatcher((): ChekUserSession => createAction(USER_ACTION_TYPES.CHECK_USER_SESSION));
